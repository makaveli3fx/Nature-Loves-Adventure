...
const Index: React.FC = () => {
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-up">
              <div className="relative">
                <img src="https://www.serengeti.com/assets/img/nomad-serengeti-safari-camp-amazing-safari-experience-serengeti-tanzania.jpg" alt="Serengeti National Park" className="w-full h-[500px] object-cover rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300" />
                <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-xl hidden md:block hover:shadow-2xl transform hover:scale-110 transition-all duration-300">
                  <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/09/57/f9/44/serengeti-safari-camp.jpg?w=700&h=-1&s=1" alt="Serengeti National Park" className="w-40 h-32 object-cover rounded-md" />
                </div>
              </div>
            </div>
            ...
            <div className="animate-slide-up animation-delay-200">
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
                Experience Nature's Paradise in Serengeti
              </h2>
              <p className="text-foreground/70 mb-6">
                Experience the Nature of Serengeti Where You can find an amazing  Wild Animals which amazied the nature of the serengeti national park and the Tourism Industry Visit Tanzania.
              </p>
        ...
        <section className="py-20 bg-secondary">
          <div className="container px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[{
                title: "Mobile Camps",
                image: "https://www.zicasso.com/static/21d163ab87f208350481e9c7e132c671/304cc/21d163ab87f208350481e9c7e132c671.jpg",
                description: "Wake up to the soothing sounds of the Nature and Bird's",
                price: "$2,499",
                delay: 0
              }, {
                title: "Safari Lodges",
                image: "https://www.andbeyond.com/wp-content/uploads/sites/5/Pristine-Infinty-Pools-at-Four-Seasons-Safari-Lodge.jpg",
                description: "Elevated living with panoramic forest views and Seeing Animals while enjoying youre Lodge",
                price: "$3,999",
                delay: 200
              }, {
                title: "Luxury Tents",
                image: "https://www.serengetiparktanzania.com/wp-content/uploads/2025/05/Manya-Serengeti-Luxury-Camp-2-750x450.jpg",
            ...
            {[
              {
                ...
                quote: "Throught the nature of Ngorongoro I saw Some of Amazing animal like rhino and elephant the big five the service was the amazing and I had the best moment in Tanzania.",
                image: "https://www.shutterstock.com/image-vector/vector-male-face-avatar-logo-600nw-426321556.jpg",
                delay: 0
              },
              {
                name: "Atharva Kulkarni",
                location: "Mumbai, India",
                quote: "The accomodation was amazing I had the best sleep that I never expeirence waking up with the sound of birds and the nature the service of the accomodation was awesome and the best accomodation in the Nature.",
                image: "https://www.shutterstock.com/image-vector/vector-male-face-avatar-logo-260nw-425812141.jpg",
                delay: 200
              },
              {
                name: "Rajat Hegde",
                ...
                image: "https://www.shutterstock.com/image-vector/abstract-people-icon-on-white-260nw-218988379.jpg",
                delay: 400
              }
        ...
        {/* CTA */}
        <section className="py-20 bg-green-600 text-white relative">
          <div className="absolute inset-0 bg-[url('https://media.audleytravel.com/-/media/images/home/inspiration/safari-holidays/top-10-safari-animals-in-africa/istock_1257697863_south_luagwa_3000x1000.jpg?q=79&w=1920&h=685')] bg-cover bg-center opacity-20"></div>
