...
const BookingPage = () => {
  ...
  const handleBookingSubmit = async (values: any) => {
    ...
    setCurrentBooking(values); // This is where the booking data from the form is stored
    try {
  ...
  const handlePaymentSuccess = async (paymentTransactionId: string) => {
    ...
    try {
      // Check if currentBooking is available before saving
      if (currentBooking) {
        // Save the booking data to a 'bookings' collection
        ...
        await sendEmail({
          ...
          subject: "Your Booking Confirmation - Nature Loves adventures",
          body: emailContent
        });
        ...
        console.error("No booking data available to save.");
        toast({
          title: "Error",
          description: "Booking data was not found. Please try again.",
          variant: "destructive"
        });
      }
      ...
      toast({
        ...
        description: "However, there was an issue saving to the database or sending the confirmation email.",
        variant: "default"
      });
      setBookingStep('confirmation');
    }
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <div className="relative h-[40vh] md:h-[50vh] w-full">
          ...
          backgroundImage: "url('https://www.gorillatrips.net/wp-content/uploads/2020/11/tanzania-safari-faqs-banner.jpg')",
              ...
              {bookingStep === 'confirmation' && (
                <div className="text-center py-8">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    Thank you for booking with Nature Loves adventures. We've sent a confirmation email to {currentBooking?.email} and an SMS to your phone.
                  </p>
                  {transactionId && (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 animate-fade-in animation-delay-400">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p className="text-accent">+255699809207 +255 699 809 207</p>
                  <p className="font-medium mt-3">Email:</p>
                  <p className="text-accent">naturelovesadventuresinfo@gmail.com</p>
                </div>
              </div>
              
              <div className="bg-accent/10 rounded-lg p-6 animate-fade-in animation-delay-600">
                <p className="italic text-sm mb-4">
                  "Our stay at Tanzania was absolutely magical. The staff went above and beyond to make our vacation unforgettable!"
                </p>
                <p className="font-medium text-sm"> Nature Loves Adventure</p>
              </div>
            </div>
          </div>
        </div>
...
const faqs = [{
  ...
  answer: "You can make a reservation by filling out the booking form on our website, calling our reservation team, or sending an email to bookings@naturelovesadventures.com."
}, {
