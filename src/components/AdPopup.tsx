...
export function AdPopup() {
  ...
  const handleWhatsAppClick = () => {
    ...
    window.open(`https://wa.me/+255698809207?text=${message}`, '_blank');
  };
      ...
      <DialogContent className={`sm:max-w-md p-0 overflow-hidden ${isMobile ? 'w-[90%] max-h-[80vh]' : ''}`}>
        ...
        >
          <div className="relative">
            <img 
              src="https://sunsetsafaris.co.za/wp-content/uploads/2024/07/mesmerizing-view-silhouette-tree-savanna-plains-sunset.webp" 
              alt="Day Package"
          ...
          <div className="p-6 space-y-4">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Experience the best of Tanzania at an unbeatable price
              </p>
            </motion.div>
