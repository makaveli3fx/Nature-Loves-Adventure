...
const ChatBot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<{text: string, isUser: boolean}[]>([
    { text: "👋 Hi there! I'm your personal Nature Loves adventure guide. How can I help you plan your perfect nature getaway?", isUser: false }
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      if (userInput.includes("price") || userInput.includes("cost") || userInput.includes("rate")) {
        ...
        botResponse = "📍 We're located in the beautiful Tanzania Wildlife Sanctuary. The nearest airport is Goa (160km), and we provide pickup services. Would you like me to send you detailed directions?";
      }
        ...
        botResponse = "👋 Hello! I'm excited to help you plan your Nature Loves adventure! Are you interested in our activities, accommodations, or special offers?";
      }
      else if (userInput.includes("thank")) {
        botResponse = "😊 You're welcome! Don't hesitate to ask if you need anything else. Have a great day!";
      }
      else {
        botResponse = "I'd love to help you plan your perfect Nature Loves adventure! Are you interested in our activities, accommodations, or special offers? You can also ask me about prices, locations, or current deals! 🌿";
      }
