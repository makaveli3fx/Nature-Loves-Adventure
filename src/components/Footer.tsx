        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16 px-4">
            <div className="space-y-4 animate-fade-in">
              <h3 className="text-2xl font-display font-semibold">Nature Loves Adventure</h3>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-accent-foreground/80">
                    Nature loves Adventure, Sekei Arusha Tanzania
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <Phone size={20} className="flex-shrink-0" />
                  <div className="flex flex-col">
                    <a href="https://wa.me/0698809207?text=Hi!%20I'm%20interested%20in%20booking%20an%20adventure%20at%20Dandeli." target="_blank" rel="noopener noreferrer" className="text-accent-foreground/80 hover:text-accent-foreground transition-colors duration-300">
                      +255 698 809 207
                    </a>
                    <a href="tel:+0698809207" className="text-accent-foreground/80 hover:text-accent-foreground transition-colors duration-300">
                      +255 698 809 207
                    </a>
                  </div>
                </li>
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-accent-foreground/80 text-base">NatureAdventure.info@gmail.com</span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-white/10 py-6 px-4 text-center text-accent-foreground/70">
            <p>© {currentYear} Nature Loves Adventure. All rights reserved.</p>
          </div>
        </div>
      </footer>
